...
thumbnail: "~/assets/thumbnails/clara.png"
thumbnailAlt: "Stelle and Clara together on Honkai Star Rail"
color: "rounded-lg border border-8 border-green-500"
---
...
![Stelle and Clara together on Honkai Star Rail](~/assets/thumbnails/clara.png)
...
<Callout title="Sample" type="info">
  Imagine this is a payment portal app.
</Callout>

<Callout title="Payment Success!" type="success">
  Successfully paid 500$ to @exylons!
</Callout>

<Callout title="Payment Failed." type="warning">
  There is a problem with your payment method. Please try again.
</Callout>

<Callout title="NOTICE" type="error">
...
<SpotifyEmbed
  size="small"
  link="https://open.spotify.com/track/5PspcXQtSiTDRPa8V5PHYf"
/>
<SpotifyEmbed
  size="large"
  link="https://open.spotify.com/track/5PspcXQtSiTDRPa8V5PHYf"
...
<SpotifyEmbed
  size="large"
  link="https://open.spotify.com/artist/5zixe6AbgXPqt4c1uSl94L"
/>
